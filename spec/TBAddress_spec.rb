...
RSpec.describe 'An address' do
    ...
    it 'should provide the same result if computed twice' do
        str_hashed_twice = @tb_address.hash()
...
RSpec.describe 'An empty address' do
  before :each do
      @str_original = ""
      @tb_address = TBAddress.new(@str_original)
      @str_hashed = @tb_address.hash()
  end
    it 'should provide the official result' do
        expect(@str_hashed).to eq("e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855")
    end
end
